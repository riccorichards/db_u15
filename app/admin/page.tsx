...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<"players" | "match" | "training">(
    "players",
  );
        ...
        <div className="flex gap-2 mb-6">
          {(
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-display font-bold uppercase tracking-wide transition-all ${
                activeTab === tab.id
                  ? "bg-ocean text-white"
